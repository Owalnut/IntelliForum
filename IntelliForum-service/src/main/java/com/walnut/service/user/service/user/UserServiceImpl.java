package com.walnut.service.user.service.user;

import com.walnut.api.model.context.ReqInfoContext;
import com.walnut.api.model.exception.ExceptionUtil;
import com.walnut.api.model.vo.article.dto.YearArticleDTO;
import com.walnut.api.model.vo.constants.StatusEnum;
import com.walnut.api.model.vo.user.UserInfoSaveReq;
import com.walnut.api.model.vo.user.UserPwdLoginReq;
import com.walnut.api.model.vo.user.dto.BaseUserInfoDTO;
import com.walnut.api.model.vo.user.dto.SimpleUserInfoDTO;
import com.walnut.api.model.vo.user.dto.UserStatisticInfoDTO;
import com.walnut.core.util.IpUtil;
import com.walnut.service.article.repository.dao.ArticleDao;
import com.walnut.service.statistics.service.CountService;
import com.walnut.service.user.cahce.UserInfoCacheManager;
import com.walnut.service.user.converter.UserConverter;
import com.walnut.service.user.repository.dao.UserAiDao;
import com.walnut.service.user.repository.dao.UserDao;
import com.walnut.service.user.repository.dao.UserRelationDao;
import com.walnut.service.user.repository.entity.IpInfo;
import com.walnut.service.user.repository.entity.UserAiDO;
import com.walnut.service.user.repository.entity.UserDO;
import com.walnut.service.user.repository.entity.UserInfoDO;
import com.walnut.service.user.repository.entity.UserRelationDO;
import com.walnut.service.user.service.UserAiService;
import com.walnut.service.user.service.UserService;
import com.walnut.service.user.service.help.UserPwdEncoder;
import com.walnut.service.user.service.help.UserSessionHelper;
