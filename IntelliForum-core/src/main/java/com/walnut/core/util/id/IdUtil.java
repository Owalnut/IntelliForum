package com.walnut.core.util.id;

import com.walnut.core.async.AsyncUtil;
import com.walnut.core.util.CompressUtil;
import com.walnut.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import com.walnut.core.util.id.snowflake.SnowflakeProducer;

import static com.walnut.core.util.CompressUtil.int2str;
